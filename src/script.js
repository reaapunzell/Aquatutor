const storeItems = {
    ...
    3: { id: 3, name: "Always Sensitive Sanitary Pads Ultra Super Plus", price: 52.95 + (52.95 * 0.4), image: "src/images/Always Sensitive Sanitary Pads Ultra Super Plus.webp" },
